...
contract UniswapV2PairMinimal {
    ...
    function initialize(address _token0, address _token1) external onlyOnce {
        token0 = _token0;
        token1 = _token1;
    }
    ...
    function burn(address to) external lock returns (uint256 amount0, uint256 amount1) {
        ...
        uint256 _totalSupply = totalSupply; // gas savings, must be defined here since totalSupply can update in _mint
